...
export default function About() {
  return ( <>
    ...
    <div className='flex flex-col  p-10'>
      <h1 className=' p-5 flex items-center justify-center text-[2rem]'>About Alisa</h1>


      <div className=' mb-10 bg-slate-300 flex-1 min-w-[200px] min-h-[200px]'> image of her and the team or her and shane </div>
